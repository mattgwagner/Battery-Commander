...
namespace BatteryCommander.Web.Models
{
    ...
    public class ABCP : IValidatableObject
    {
        ...
        public DateTime ValidThru => Date.AddMonths(6);
        ...
        /// </summary>
        [NotMapped, Display(Name = "Progress?")]
        public Boolean? IsSatisfactory
        {
            get
            {
                if (Previous != null)
                {
                    if (!RequiresTape || Measurements.Any())
                    {
...
",
                ...
                Assessment = $@"
{(IsSatisfactory.HasValue ? $"{(IsSatisfactory == true ? "SATISFACTORY" : "UNSATISFACTORY")} progress for the month: {Weight - Previous.Weight}lbs, {BodyFatPercentage - Previous.BodyFatPercentage}% body fat." : "")}
"
            });
        }
